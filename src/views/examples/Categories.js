...
class Tables extends React.Component {
  ...
  toggle = (v) => this.setState({ modal: !this.state.modal, viewCategoryDetails: v });


  deleteCategory(e) {
    post({ _id: e._id }, "category/delete").then(({ data }) => {
      this.setState({ categoryList: this.state.categoryList.filter((x) => e._id !== x._id) })
                ...
                <CardHeader className="border-0">
                  <Row>
                    <Col xs="6" style={{
                      ...
                      {/* <Row>
                        <Col xl="12" xs="12" lg={"12"} style={{backgroundColor:"red"}} > */}
                          <FormGroup>
                            <Input
                    ...
                    <Col style={{ textAlign: "right" }} xs="6">
                      <Nav style={{ textAlign: "right", justifyContent: "flex-end" }}  >
                        <NavItem >
                          <NavLink to={"/admin/crete-category"} tag={NavLinkRRD}  activeClassName="active">
                  ...
                  <tbody style={{ textAlign: "center" }}>
                        ...
                        <tr key={x} >
                          <td>
                            <a
                              ...
                              <img style={{ height: 50, width: 50 }} alt="..." src={v.category_image}
                              />
                            </a>
                          </td>
                    ...
                    <div>
                      <Modal isOpen={this.state.modal} className="modal-container" toggle={this.toggle} >
                        ...
                        <ModalFooter>
                          <Button color="" onClick={this.deleteCategory.bind(this, viewCategoryDetails)}>Delete</Button>
                          <Nav style={{ textAlign: "right", justifyContent: "flex-end" }}  >
                            <NavItem onClick={() => { }}>
                              <NavLink to={"/admin/crete-category"} tag={NavLinkRRD} onClick={() => { }} activeClassName="active">
                                <Button color="info" onClick={() => { this.setState({ modal: false }); localStorage.setItem("updateCategory", JSON.stringify(viewCategoryDetails)) }}>Edit</Button>
                              </NavLink>
                            </NavItem>
                          </Nav>
                        </ModalFooter>
